    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "notes",
                    models.TextField(blank=True, verbose_name="user_explanation"),
                ),
        ...
        migrations.AddIndex(
            model_name="booking",
            index=models.Index(
                fields=["pitch", "booking_date"], name="bookings_pitch_i_1fabf0_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="booking",
            index=models.Index(
                fields=["tracking_code"], name="bookings_trackin_6081b7_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="booking",
