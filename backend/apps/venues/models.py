...
class Pitch(models.Model):
    ...
    weekend_price = models.DecimalField(
        ...
        null=True, blank=True,help_text='if not set, same as price_per_hour'
    )
...
class WorkingHours(models.Model):
    ...
    day_of_week = models.IntegerField(
        choices=DAYS_OF_WEEK, db_index=True
    )
...
class Image(models.Model):
    ...
    image = models.ImageField(upload_to=pitch_image_path,
    validators=[validate_image_size], help_text='maximum 5 megabyte')
